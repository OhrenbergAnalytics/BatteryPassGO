...
if st.session_state.current_page == "general":
    ...
    st.write(f"Internal cell resistance: **{cell['Internal resistance [Ω]']} mΩ**")
    st.write(f"Internal pack resistance: **{resistance_pack} mΩ**")
    ...
    st.write(f"Internal resistance (cell): **{form_data.get('resistance_cell', 'n/a')} mΩ**")
    st.write(f"Internal resistance (pack): **{form_data.get('resistance_pack', 'n/a')} mΩ**")
